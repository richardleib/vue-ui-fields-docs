...
<template>
	<section>
		<div class="intro">
			...
			<p class="intro__info">
				If you want to check if a value of another field is NOT equal to some
				other field you can use this validation. If field A has a value of
				'hello' and field B has value of 'hey', this validation gives NO error
			</p>
		...
		<div class="usage" :class="!isCode ? 'hide' : ''">
			...
			<VueCodeHighlight language="javascript">
				...
				validation: [ { name: 'notequalto', options: () =>
